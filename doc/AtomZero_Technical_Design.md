...
> **Game Name**: AtomZero  
> **Game Version**: `2026.9.0` (Release, uses SemVer range matching detection)  
...
> The current game version `2026.9.0` is a release version; all Mods' `game_version` fields are subject to **SemVer range matching detection** at load time.
...
sequenceDiagram
	...
	loop Load each Mod in order
		...
		ML->>Mod: Instantiate entry script
...
> This document is the Atom Life technical design v2026.9.0. Future iterations will be supplemented on this basis as needed.
